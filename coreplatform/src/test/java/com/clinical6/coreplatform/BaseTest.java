package com.clinical6.coreplatform;
...
public class BaseTest {
    ...
    static final String BODY = System.getProperty("user.dir") + "/data/body/";
	...
	public void setup(@Optional("dev") String env) throws Exception {	
		...
		if (env.equalsIgnoreCase("dev")) {
			testfilepath = System.getProperty("user.dir") + "/data/dev/testdata.json";
		}
